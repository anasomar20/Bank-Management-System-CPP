...
private:
    ...
    static void _PerformManageUsersMenueOption(enManageUsersScreen ManageUsersMenueOption)
    {
...
public:
	...
	static void ShowManageUsersMenue()
	{
        ...
        _PerformManageUsersMenueOption(enManageUsersScreen(ReadManageUsersMenueOption()));
	}
};
